        ...
        filter.enter()
          ...
          .on("mouseover", function(event, d) {
            if (d.timestep == 1300000){
              ...
              d3.select("p#filterInfo")
                .text("Yellow line with long vertical section indicates agent learned a new strategy");
              d3.select("#filterStack")
                .attr("src", "./img/dqn/filter/timestep_1300000/strategy.png");
          	} else {
              tooltip.transition()
                .style("opacity", 1)
              tooltip.html("Filtered by the highest mean score achieved" + "<br/>" + "Score: " + d.mean + "<br/>" + "SD: " + d.std + "<br/>" + "Length: " + d.length + "<br/>" + "Timestep: " + d.timestep)
                ...
                .style("top", (event.pageY - 75) + "px");
              d3.select("p#filterInfo")
                .text("Green line with longer horizontal end indicates agent failing to catch the ball");
              d3.select("#filterStack")
                .attr("src", "./img/dqn/filter/timestep_4300000/fail.png");
              }
          })
          .on("mouseout", function(d) {
            tooltip.transition()
        ...
        filter.enter()
          ...
          .on("mouseover", function(event, d) {
            if (d.timestep == 3450000){
              ...
              d3.select("p#filterInfo")
                .text("Light green line with long horizontal end indicates the agent stuck in a loop");
              d3.select("#filterStack")
                .attr("src", "./img/dqn/filter/timestep_3450000/loop.png");
          	} else {
              tooltip.transition()
                .style("opacity", 1)
              tooltip.html("Filtered by a drop in rewards of 300 or more" + "<br/>" + "Reward: " + d.reward + "<br/>" + "Timestep: " + d.timestep)
                ...
                .style("top", (event.pageY - 60) + "px");
              d3.select("p#filterInfo")
                .text("Purple line with long horizontal end indicates the agent stuck in a loop");
              d3.select("#filterStack")
                .attr("src", "./img/dqn/filter/timestep_4850000/loop.png");
            }
          })
          .on("mouseout", function(d) {
            tooltip.transition()
