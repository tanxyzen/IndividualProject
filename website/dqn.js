...
function score() {
    ...
    points.enter()
      ...
      .on("click", function(event, d) {
        ...
        d3.select("#rewardFreqImg")
          .attr("src", "./img/dqn/reward_freq_stack/reward_freq_" + d.timestep + "_steps.png");
        d3.select("#gif")
          .attr("src", "./img/dqn/simulation/gif_" + d.timestep + ".gif");
        d3.select("p#gifScore")
          .text("Playback Score " + d.score);
        d3.select("p#filterInfo")
          .text("");
        d3.select("#filterStack")
          .attr("src", "");
  ...
  d3.json(url2).then( data => {
    ...
    d3.select("#score1").on("click", function(event) {
      ...
      if (timestepVar == 1300000) {
        d3.select("#gif")
          .attr("src", "./img/dqn/simulation/gif_1300000.gif");
        d3.select("p#gifScore")
          .text("Playback Score 310");
      }
      else if (timestepVar == 4300000) {
        d3.select("#gif")
          .attr("src", "./img/dqn/simulation/gif_4300000_A.gif");
        d3.select("p#gifScore")
          .text("Playback Score 395");
      }
    });
    d3.select("#score2").on("click", function(event) {
      ...
      if (timestepVar == 1300000) {
        d3.select("#gif")
          .attr("src", "./img/dqn/simulation/gif_1300000_B.gif");
        d3.select("p#gifScore")
          .text("Playback Score 177");
      }
      else if (timestepVar == 4300000) {
        d3.select("#gif")
          .attr("src", "./img/dqn/simulation/gif_4300000_B.gif");
        d3.select("p#gifScore")
          .text("Playback Score 346");
      }
    });
    d3.select("#score3").on("click", function(event) {
      ...
      if (timestepVar == 1300000) {
        d3.select("#gif")
          .attr("src", "./img/dqn/simulation/gif_1300000_C.gif");
        d3.select("p#gifScore")
          .text("Playback Score 126");
      }
      else if (timestepVar == 4300000) {
        d3.select("#gif")
          .attr("src", "./img/dqn/simulation/gif_4300000.gif");
        d3.select("p#gifScore")
          .text("Playback Score 332");
      }
    });
    d3.select("#score4").on("click", function(event) {
      ...
      if (timestepVar == 1300000) {
        d3.select("#gif")
          .attr("src", "./img/dqn/simulation/gif_1300000_D.gif");
        d3.select("p#gifScore")
          .text("Playback Score 111");
      }
      else if (timestepVar == 4300000) {
        d3.select("#gif")
          .attr("src", "./img/dqn/simulation/gif_4300000_D.gif");
        d3.select("p#gifScore")
          .text("Playback Score 283");
      }
    });
